...
void RenderImGui()
{
	...
	ImGui::Checkbox("Stochastic", &settings.stochastic);      // Edit bools storing our window open/close state
...
int main(int argc, char** argv)
{
	...
	// Load scene file
	//"C:/Users/elias/Downloads/simple_low_poly_crown/scene.gltf"
	//"C:/Users/elias/Downloads/low_poly_mccree/scene.gltf"
...
void runCuda()
{
	...
	if (iteration < renderState->iterations)
	{
		...
		// execute the kernel
		int frame = 0;
		pathtrace(pbo_dptr, frame, iteration, settings);
